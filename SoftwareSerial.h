...
#define _SS_MAX_RX_BUFF 64 // RX buffer size, modify roshan 2022-04-03, was 256,  // RX buffer size, modify roshan 2022-MARCH-11, was 64
#endif
...
public:
    ...
    void begin(uint32_t baud, Config config,
        int8_t rxPin, int8_t txPin, bool invert,
        int bufCapacity = _SS_MAX_RX_BUFF, int isrBufCapacity = 0) {
